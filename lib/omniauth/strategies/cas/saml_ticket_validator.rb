      ...
      private
        ...
        def find_authentication_success(body)
          ...
          begin
            ...
            if @options.saml == true && doc.remove_namespaces!.xpath("//StatusCode").first.attributes["Value"].value == "samlp:Success"
        ...
        def get_service_response_body
          ...
          response, data = http.post "#{@uri.path}?#{@uri.query}", soap, headers
          response.body
        end
